...
function alzaCb() {
  ...
  const ys = [
    ...
    281, 290, 298, 307, 316, 326, 336, 346, 356, 366
  ];
...
function altMaxCb() {
  ...
  const ys = [
    58, 61, 65, 68, 71, 75, 79, 83, 87, 91,
    95, 99, 103, 108, 112, 117, 122, 127, 132, 137,
    143, 148, 154, 160, 166, 172, 178, 185, 192, 199
  ];
...
function colD (){
    ...
    else if(alcancePvCb () < 11400){
        var D = 5.4;
    }
    else if(alcancePvCb () < 12000){
        var D = 5.5;
    }
    return D;
}
...
function colE() {
  const x = alcancePvCb();
  const xs = Array.from({ length: 32 }, (_, i) => 4000 + i * 200);
  const ys = [
    -0.95, -0.99, -1.03, -1.07, -1.11, -1.15, -1.19, -1.23,
    -1.26, -1.3, -1.33, -1.37, -1.4, -1.43, -1.46, -1.49,
    -1.52, -1.56, -1.59, -1.63, -1.66, -1.7, -1.74, -1.78,
    -1.82, -1.87, -1.91, -1.96, -2.01, -2.06, -2.11, -2.11
  ]; 
...
function colF() {
  ...
  const ys = [
    ...
    -0.99, -0.99, -0.99, -0.99, -0.98, -0.98, -0.98, -0.97,
    -0.97, -0.97, -0.96, -0.96, -0.96, -0.95, -0.95, -0.95,
